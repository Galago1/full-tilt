...
export interface UseCardSectionHeaderProps extends CardHeaderProps {
  /**
...
const useCardSectionHeaderProps = ({
  supportingText = false,
  type = 'none',
  fieldAttributes,
  ...props
}: UseCardSectionHeaderProps): CardHeaderProps => {
...
export default useCardSectionHeaderProps;
